...
func TestProxmoxAPIClient_FindVMTemplatesByTags(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			fails:          false,
			err:            "",
			vmTemplateNode: map[string]int32{"capmox01": 504},
			localStorage:   false,
			allowedNodes:   []string{"capmox01", "capmox02"},
		},
		{
			...
			vmTags:         []string{"template-duplicate"},
			fails:          true,
			err:            "found 1 templates on allowedNodes \"capmox01,capmox02\" with tags \"template-duplicate\"",
		...
		},
		{
			...
			fails:          false,
			err:            "",
			vmTemplateNode: map[string]int32{"capmox01": 404},
			localStorage:   false,
			allowedNodes:   []string{"capmox01", "capmox02"},
		},
		{
			...
			vmTags:         []string{"template-duplicate", "same-node"},
			fails:          true,
			err:            "found 1 templates on allowedNodes \"capmox01,capmox02\" with tags \"template-duplicate;same-node\"",
			vmTemplateNode: map[string]int32{},
			localStorage:   true,
			allowedNodes:   []string{"capmox01", "capmox02"},
		},
		{
			...
			fails:          true,
			err:            "found 1 templates on allowedNodes \"capmox01,capmox02\" with tags \"template-duplicate;multiple-nodes\"",
			vmTemplateNode: map[string]int32{},
			localStorage:   true,
			allowedNodes:   []string{"capmox01", "capmox02"},
		},
